            ...
            <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start mb-2">
                        ...
                        <BsBookmark className="text-gray-400 cursor-pointer hover:text-blue-600 ml-2 shrink-0" size={14} />
                    </div>
        ...
        <div className="w-full">
            ...
            <div className="mb-6">
                ...
                <div className="flex gap-3 mb-4">
                    ...
                    <button className="bg-[#0154AA] text-white px-6 py-2.5 rounded-md hover:bg-blue-700 transition-colors flex items-center gap-2 font-medium">
